...
public static class SQLite3Native
{
	...
	public static extern Result Open([MarshalAs(UnmanagedType.LPUTF8Str)] string filename, out IntPtr db);

	[DllImport(LibraryPath, EntryPoint = "sqlite3_open_v2", CallingConvention = CallingConvention.Cdecl)]
	public static extern Result Open([MarshalAs(UnmanagedType.LPUTF8Str)] string filename, out IntPtr db, int flags, [MarshalAs(UnmanagedType.LPStr)] string zvfs);
	...
	public static extern Result Prepare2(IntPtr db, [MarshalAs(UnmanagedType.LPUTF8Str)] string sql, int numBytes, out IntPtr stmt, IntPtr pzTail);
	...
	{
		return Marshal.PtrToStringUni(SQLite3Native.ColumnText16(stmt, index));
	}
